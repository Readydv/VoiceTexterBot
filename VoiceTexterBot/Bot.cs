...
namespace VoiceTexterBot
{
    internal class Bot : BackgroundService
    {
        ...
        private DefaulttMessageController _defaulttMessageController;
        private InlineKeyboardController _inlineKeyboardController;

        public Bot (ITelegramBotClient telegramClient, TextMessageController textMessageController,
            VoiceMessageController voiceMessageController, DefaulttMessageController defaulttMessageController,
            InlineKeyboardController inlineKeyboardController)
        {
            ...
            _defaulttMessageController = defaulttMessageController;
        }

        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            _telegramClient.StartReceiving(HandleUpdateAsync, HandleErrorAsync, new ReceiverOptions() { AllowedUpdates = { } }, 
            ...
            if (update.Type == UpdateType.Message)
            {
                switch (update.Message!.Type)
                {
                    ...
                    case MessageType.Text:
                        ...
                        return;
                    default:
                        await _defaulttMessageController.Handle(update.Message, cancellationToken);
                        return;
                }
            }    
        }
